const book = // 2) objekti
{
array : [ //3) kopioidaan bookArr
    { 
        id_book: 1, 
...
getOneBook(x)
{
 console.log(this.array[x]) //hakee solun numeron mukaan, ei kirjan id:n
},

addBook(id_book, name, author, isbn)
{
    this.array.push({ id_book, name, author, isbn});
    console.log("Added: ", id_book, name, author, isbn);
},
}
//5) testit:
book.getAllBooks();
book.addBook(16, "Art of War", "Sun Tzu", "1084874123");
book.getOneBook(15);